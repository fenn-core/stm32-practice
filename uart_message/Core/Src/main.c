...
int main(void)
{
  ...
  /* USER CODE BEGIN 1 */
	char *first_message = "greetings from microcontroller land! \r\n";
	char *follow_up_message = "Heey! I can feel that! \r\n";
	uint32_t first_length = 0;
	uint32_t follow_up_length = 0;
	char *p = first_message;
	while (*p != '\0'){
		first_length++;
		p++;
	};
